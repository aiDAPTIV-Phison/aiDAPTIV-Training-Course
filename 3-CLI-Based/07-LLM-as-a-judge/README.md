...
In this lesson, you’ll learn how to use **LLMs as evaluators** to detect hallucinations in model outputs. Instead of relying on string similarity metrics (like edit distance), LLM-as-a-Judge leverages reasoning to score responses more accurately.  
